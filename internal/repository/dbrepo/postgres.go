...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	// context with timeout makes sure the transaction has a limited ammount of
	// time to go through
...
// InsertRoomRestriction iserts a room restriction into the database
...
// SearchAvailabilityForAllRooms returns a slice of available rooms if any exist for given date range
...
func (m *postgresDBRepo) UpdateReservation(u models.Reservation) error {
	...
	query := `update reservations set
		first_name = $1, last_name = $2, email = $3, phone = $4, updated_at = $5 where id = $6`
...
// AllRooms returns a slice of all the existing rooms
